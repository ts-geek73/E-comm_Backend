    ...
    createStepTools() {
        ...
        const stepHandler = async ({ args, matchOp, opts, }) => {
            ...
            if (this.state.steps[opId.id]) {
                ...
                for (let i = 1;; i++) {
                    const newId = [originalId, InngestStepTools_js_1.STEP_INDEXING_SUFFIX, i].join("");
            ...
            if (typeof (stepState === null || stepState === void 0 ? void 0 : stepState.input) !== "undefined" &&
                ...
                switch (opId.op) {
                    ...
                    case types_js_1.StepOpCode.AiGateway: {
                        extraOpts = {
                            body: Object.assign(Object.assign({}, (typeof ((_b = opId.opts) === null || _b === void 0 ? void 0 : _b.body) === "object"
            ...
            const step = Object.assign(Object.assign({}, opId), { opts: Object.assign(Object.assign({}, opId.opts), extraOpts), rawArgs: fnArgs, // TODO What is the right value here? Should this be raw args without affected input?
                ...
                fn: (opts === null || opts === void 0 ? void 0 : opts.fn) ? () => { var _a; return (_a = opts.fn) === null || _a === void 0 ? void 0 : _a.call(opts, ...fnArgs); } : undefined, promise, fulfilled: isFulfilled, hasStepState: Boolean(stepState), displayName: (_c = opId.displayName) !== null && _c !== void 0 ? _c : opId.id, handled: false, handle: async () => {
                    if (step.handled) {
                        return false;
                    }
                    step.handled = true;
