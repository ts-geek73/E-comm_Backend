...
router.get('/', productController.getAllProducts as unknown as RequestHandler );
router.get('/combos', productController.getBrandsAndCategories as unknown as RequestHandler );
...
router.get('/:id', productController.getProductById as unknown as RequestHandler );
